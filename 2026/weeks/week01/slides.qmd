...
::: {.callout-note icon=false title="Amanda Vieira"}
Ayudante del curso · Pontificia Universidad Católica de Chile

📧 [amanda.vieira@uc.cl](mailto:amanda.vieira@uc.cl)
:::

El horario de ayudantía se usará primariamente para revisión d e la bibliografía del curso y como complemento al trabajo práctico de los talleres a realizar en los horarios de cátedra. 
...
## Política de IA en este curso {.smaller background-color="white"}

::: {style="font-size: 0.95em;"}
| Evaluación | Uso de IA |
|:---|:---|
| **Proyecto grupal y tareas aplicadas** | **Permitido como apoyo**: revisión de redacción, corrección y documentación de código R, exploración de ideas. Requiere **anexo obligatorio** declarando herramientas y usos. |
...
## Encuestas operando en la sociedad chilena {.smaller background-color="white"}

::: {style="font-size: 0.9em;"}
Las encuestas no son un asunto solo académico: producen los números con que la sociedad chilena se describe y se gobierna.
...
## De la muestra a la población {.smaller background-color="white"}
...
## ¿Qué clase de ciencia es la sociología? {.smaller background-color="white"}
...
## Dos tareas: hacer visible y hacer transparente {.smaller background-color="white"}
...
## El lugar de la encuesta {.smaller background-color="white"}
...
## Medir: asignar números según una regla {.smaller background-color="white"}
...
## Constructos latentes, indicadores indirectos {.smaller background-color="white"}
...
## Qué se pierde y qué se gana al medir {.smaller .dark-background}
...
## El problema fundacional {.smaller background-color="white"}
...
## Dos intentos fallidos {.smaller background-color="white"}
...
## La solución probabilística {.smaller background-color="white"}
...
## 1936: el tamaño no corrige un mal diseño {.smaller background-color="white"}
...
## ¿El Big Data mató a la encuesta? {.smaller background-color="white"}
...
## Una definición de trabajo {.smaller background-color="white"}
...
## El rasgo que define el campo {.smaller background-color="white"}
...
## La encuesta no es la única vía (ni la "mejor") {.smaller background-color="white"}
...
## Ejemplo: ¿cuánta delincuencia hay en Chile? {.smaller background-color="white"}
...
## Cinco preguntas para leer cualquier encuesta {.smaller background-color="white"}
...
## Las dimensiones del diseño {.smaller background-color="white"}
...
## Distintos contextos de producción {.smaller .dark-background}
...
## Leamos cuatro encuestas reales {.smaller background-color="white"}
...
## Encuesta CASEN 2024 {.smaller background-color="white"}
...
## II ENUT 2023 {.smaller background-color="white"}
...
## ELSOC (COES) {.smaller background-color="white"}

::: {style="font-size: 0.85em;"}
- **Mandante:** COES (ANID) / **Ejecutor:** CMD (UChile).
...
## Plaza Pública Cadem 2026 {.smaller background-color="white"}
...
## No existe la encuesta perfecta {.smaller background-color="white"}

Lo que vimos hoy, en una página:
...
## Lo que viene {.smaller background-color="white"}
